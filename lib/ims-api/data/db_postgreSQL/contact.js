...
var Contact = {
  getContacts: function (user_id, callback) {
    let queryString = "SELECT contact_list.dialog_id, user_account.user_id, user_account.status, user_account.email, user_account.name, user_account.avatar, user_account.phone FROM user_account, contact_list WHERE contact_list.contact_id = user_account.user_id AND contact_list.user_id =" + user_id;
