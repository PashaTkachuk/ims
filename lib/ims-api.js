...
router.get('/message/:user_id', message_router.getMessagesFromUser);
router.post('/message', message_router.addMessage);
router.put('/message/:id', message_router.updateMessage);
router.delete('/message/:id', message_router.deleteMessage);
